...
public class Menu {
    ...
    private void createSettingsSet(){
        ...
        Button back = new BackBtn(10, Data.gameHeight-90);
    ...
    private void createLevelsSet1(){
        ...
        Button back = new LevelsBack(10, Data.gameHeight-90);
        Button next = new NextButton(Data.gameWidth/2-30, Data.gameHeight/2+170);
    ...
    private void createLevelsSet2(){
        ...
        Button back = new LevelsBack(10, Data.gameHeight-90);
        Button previous = new PreviousButton(Data.gameWidth/2-20, Data.gameHeight/2-300);
